...
export { ConfigService as configService } from './config.service';
...
export { DevicesConfigService as deviceConfigService } from './devices-config.service';
...
export { FilesService as filesService } from './files.service';
